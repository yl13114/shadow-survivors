...
func _ready():
	...
	%GoldUpgradesButton.pressed.connect(on_gold_upgrades_pressed)
...
func on_gold_upgrades_pressed():
	ScreenTransition.transition()
	await ScreenTransition.transitioned_halfway
	get_tree().change_scene_to_file("res://scenes/ui/gold_upgrade_menu.tscn")
